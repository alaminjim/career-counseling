...
const StatCard = ({ stat, index }) => {
  ...
  return (
    ...
    >
      <div
        className={`w-16 h-16 ${stat.bg} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 shadow-[0_0_15px_rgba(0,0,0,0.1)]`}
      >
      ...
      <p className="font-bold text-[#9CA3AF] mt-3 text-[10px] uppercase tracking-[0.3em]">
        {stat.label}
      </p>
    </_motion.div>
  );
...
const faqs = [
  {
    ...
    a: "Our process begins with a comprehensive assessment of your skills, interests, and goals. You're then matched with a certified counselor who creates a personalized roadmap. Sessions are conducted via video call, and you'll receive ongoing support through our platform.",
  },
  {
    q: "What qualifications do your counselors have?",
    a: "All counselors hold advanced degrees and have 10+ years of industry experience. They're certified in career coaching methodologies and undergo continuous training to stay current with market trends.",
  },
  {
    q: "How long until I see results?",
    a: "Most clients see tangible results within 4-8 weeks – whether that's interview callbacks, skill improvements, or clarity on their career direction. Our average client lands their target role within 3 months.",
  },
  {
    q: "Can I get a refund if I'm not satisfied?",
    a: "Absolutely! We offer a 100% satisfaction guarantee. If you're not seeing progress after your first 3 sessions, we'll refund your investment in full – no questions asked.",
  },
];
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <p className="text-xl text-[#9CA3AF] leading-relaxed max-w-xl font-bold">
                Navigate your professional journey with precision-engineered
                roadmaps, expert counseling, and data-driven career diagnostics.
              </p>
              ...
              <div className="flex items-center gap-6 pt-4">
                <div className="flex -space-x-3">
                  {[...Array(4)].map((_, i) => (
                    <div
                      key={i}
                      className="w-12 h-12 rounded-full border-4 border-[#0B1020] bg-[#1F2937] overflow-hidden shadow-2xl"
                    >
                      <img
            ...
            >
              <div className="relative z-10 space-y-10 bg-[#1F2937] p-12 lg:p-16 rounded-[3.5rem] border border-[#374151]">
                <div className="space-y-4">
                  ...
                  <p className="text-[#9CA3AF] font-bold text-lg leading-relaxed">
                    Enter your professional email to initialize your baseline
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center gap-8 pt-2">
                    <p className="text-[10px] text-gray-500 font-black uppercase tracking-[0.2em] flex items-center gap-2">
                      <Zap size={12} className="text-amber-400" /> No Card
                      Required
                    </p>
                    <p className="text-[10px] text-gray-500 font-black uppercase tracking-[0.2em] flex items-center gap-2">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="text-center max-w-3xl mx-auto mb-24 space-y-8">
              ...
              <p className="text-[#9CA3AF] text-xl font-bold leading-relaxed">
                We provide the critical tools and elite counseling necessary to
                navigate the modern professional landscape.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  icon: Users,
                  desc: "1-on-1 intensive sessions with industry sector leads.",
                },
                {
                  title: "ATS Optimization",
                  icon: FileText,
                  desc: "Architecting high-conversion professional identities.",
                },
                {
                  title: "Mock Lab",
                  icon: MessageCircle,
                  desc: "High-fidelity behavioral and technical simulations.",
                },
                {
                  title: "Diagnostics",
                  icon: Target,
                  desc: "Data-driven gap analysis & competitive assessment.",
                },
              ].map((feature, idx) => (
                <_motion.div
                  key={idx}
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-[#9CA3AF] font-bold leading-relaxed text-[15px]">
                      {feature.desc}
                    </p>
                  </div>
          ...
          >
            <div className="relative z-10 max-w-3xl mx-auto space-y-14">
              ...
              <p className="text-[#9CA3AF] text-xl font-bold leading-relaxed max-w-2xl mx-auto">
                Join our elite professional community and receive the strategic
                advantage required to dominate your industry.
              </p>
            ...
            <div className="space-y-8">
              {faqs.map((faq, idx) => (
                ...
                >
                  ...
                  >
                    <span className="font-black text-xl text-white group-hover:text-indigo-400 transition-colors pr-8 leading-tight">
                      {faq.q}
                    </span>
                    <div
                      className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-500 shrink-0 ${openFAQ === idx ? "bg-indigo-600 text-white shadow-2xl rotate-180" : "bg-[#111827] text-gray-500 group-hover:text-white border border-[#374151]"}`}
                    >
                      <ChevronDown size={28} />
                    </div>
                  </button>
                    ...
                    {openFAQ === idx && (
                      ...
                      >
                        <div className="px-10 md:px-12 pb-12">
                          <p className="text-[#9CA3AF] font-bold text-lg leading-relaxed border-t border-[#374151]/50 pt-10">
                            {faq.a}
                          </p>
                        </div>
                      </_motion.div>
