            ...
            <div className="bg-[#1F2937] rounded-[4.5rem] p-16 md:p-24 shadow-2xl border border-[#374151] relative overflow-hidden">
              ...
              <form onSubmit={handleProfileUpdate} className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-4">
                  ...
                  <div className="relative group">
                    <User className="absolute left-8 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-indigo-400 transition-colors" size={24} />
                    <input 
                      type="text" 
                      name="name"
                      defaultValue={user?.displayName}
                      className="input-premium pl-20 py-6 text-white font-black uppercase text-[11px] tracking-widest shadow-inner !bg-[#111827]" 
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative group">
                    <Camera className="absolute left-8 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-indigo-400 transition-colors" size={24} />
                    <input 
                      type="text" 
                      name="photo"
